...
final class PushCell: BaseCollectionCell {
    ...
    private let pushLabel = UILabel(.systemFont(ofSize: 12), .black, Strings.pushesAboutOrder)
    private let optionDescriptionLabel = UILabel(.systemFont(ofSize: 12), .textGray, Strings.writeAboutBook)
